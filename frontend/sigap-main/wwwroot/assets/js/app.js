...
(function ($) {
    ...
    function initLogin() {
        const inputUsername = $('#validationServerUsername');
        const feedbackUsername = $('#validationServerUsernameFeedback');
        const inputPassword = $('#validationServerPassword');
        const feedbackPassword = $('#validationServerPasswordFeedback');
        ...
        // $(document).on('submit', '#formLogin', function(e) {
            ...
            Swal.fire({
                title: 'Memproses...',
                html: '<div class="spinner-border text-danger mt-2" role="status" style="width:3rem;height:3rem;"></div>',
            ...
            $.ajax({
                ...
                error: function (xhr) {
                    ...
                    if(errors.username) {
                        ...
                        feedbackUsername
                            .removeClass('d-none')
                            // .html(errors.username[0]);
                            .html("Username tidak ditemukan!");
                    } else {
                        inputUsername.removeClass('is-invalid');
                        feedbackUsername.addClass('d-none');
                    }
                    ...
                    if(errors.password) {
                        ...
                        feedbackPassword
                            ...
                            .html("Password tidak valid!");
                    } else {
                        inputPassword.removeClass('is-invalid');
                        feedbackPassword.addClass('d-none');
                    }
